class TenantMapper:
    """Interface for mapping django bits to a name, based on a request.
    ...
    def get_tenant_name(self, request):
        """Returns an opaque identifier for the current name."""
        raise NotImplementedError

    def get_db_name(self, request, tenant_name):
        """Returns the database name which should be used for this name."""
        raise NotImplementedError

    def get_cache_prefix(self, request, tenant_name, db_name):
        """Returns the cache prefixed to be used for this name."""
        raise NotImplementedError
